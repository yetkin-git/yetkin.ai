...
**Canlı reçete:** Motor 4 / Kamu Vitrini 3 Oda (Panel, Akademi, Kariyer) + çekirdek yetenekler (`/profil`, `/cuzdan`, `/pasaport`, `/admin`). Freelancer motor sicilinde durur; kamu yüzeyi **410**. Akademi mühürlü yayın **2**’dir (`01_office_ai-1`, `01_office_ai-2`); kalan dersler taze bake bekler. Dron T3 Akademi yüzeyi bağlıdır; Tezgâh donuk. Video katmanı terk edilmiştir. Motor 2 keşif fazındadır.
...
Closed Testing reçetesi T3 B2C (`ops-dron.md`). Tezgâh yüzeyi izole; Split ayrı idari kapıdır. Mağaza binary: `apps/rail-is/eas.json` (CI eas yok). İnceleme notu: `docs/MAĞAZA_INCELEME_NOTU.md`.
