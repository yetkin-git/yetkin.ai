...
## Ders → Native Yüzey Matrisi (`01_office_ai`, 8 ders)

SSOT: `lib/academy/curricula/lesson-index.ts`. Vatandaş sırası 1…8. Teknik sonek ders numarası değildir. `01_office_ai-4` sınav yolunda yoktur (arşiv). Hazırlık şeridi `01_office_ai-0` bu sayıya girmez.
...
| 6 | `01_office_ai-g1` | Sesli anlatım + makale + rozetler | Gmail + Outlook posta masası |
