...
/** Kamu ve auth sayfalarında yasal URL'ler kaydırmadan tabanda durur. */
    ...
    <footer className="pointer-events-none fixed inset-x-0 bottom-0 z-40 bg-gradient-to-t from-[var(--background)] from-35% to-transparent">
      ...
      >
        {LEGAL_FOOTER_LINKS.map((link) => {
          const className =
            "shrink-0 whitespace-nowrap rounded-md px-2 py-1 text-[11px] font-medium tracking-wide text-[var(--muted)] opacity-55 transition-opacity hover:opacity-100 hover:underline sm:px-2.5 sm:text-xs";
