...
/** Kasa ve footer — SSL rozeti + PayTR logosu. Yasal sözleşme metninden ayrıdır. */
  ...
  return (
    ...
    >
      <p
        ...
        className="inline-flex items-center gap-1.5 rounded-md border border-[var(--border)] bg-[var(--surface)] px-2 py-1 text-[10px] font-semibold tracking-wide text-[var(--foreground)]"
      >
