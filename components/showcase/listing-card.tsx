    ...
    <div
      className={cn(
        ...
        isList
          ...
          : showCover
            ? "mt-auto flex-col gap-3 pt-4 sm:flex-row sm:items-center sm:gap-4"
            : "mt-auto pt-4",
      )}
    >
      ...
      {href && hit === "cta" ? (
        <LinkButton
          href={href}
          variant={showcase ? "outline" : ctaVariant}
          size={ctaSize}
          className={cn("shrink-0 whitespace-nowrap", wideCta && "w-full sm:w-auto")}
        >
          {cta}
        </LinkButton>
      ) : hit === "card" && cta ? (
