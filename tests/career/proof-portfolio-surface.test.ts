...
describe("kariyer kanıt portföyü yüzeyi", () => {
  it("vize defteri ve teklif kapısı basar; koç/SWOT/radar sökülüdür", () => {
    ...
    expect(SEN_VOICE.career.passportCta).toBe("Pasaport");
    expect(SEN_VOICE.career.certificatesCta).toBe("Sertifikalarım");
    expect(SEN_VOICE.career.freelancerBoardCta).toBe("Freelancer İlan Panosu");
    ...
    expect(copy).toContain("Teklif Kapısı");
    ...
    expect(SEN_VOICE.career.ledger.eyebrow).toBe("Pasaport Vize Damgası");
    expect(SEN_VOICE.career.scope.eyebrow).toBe("Teklif Kapısı");
    ...
    expect(SEN_VOICE.career.scope.examGate).toBe("8 ders + baraj 70");
    expect(copy).not.toContain("Belge yok");
    expect(copy).not.toContain("Belgen var");
    expect(copy).toContain("Sınav mühürlü");
    expect(copy).toContain("8 ders + baraj 70");
    expect(copy).toContain("8 dersi bitir");
