...
export const PAZARYERI_SEN = {
  ...
  stall: {
    ...
    eidsLocked:
      "EİDS kimlik ve yetki doğrulaması tamamlanmadan emlak ve vasıta kamu ilanı yayımlanamaz.",
    submit: "Tezgâha koy",
  ...
  purchase: {
    ...
    bridgeTitle: "Sipariş alındı",
    bridgeBody: "Çift nakit yolu siparişlerde dürüst yansır.",
    bridgeCta: "Siparişleri aç",
  },
  delivery: {
    confirm: "Teslimi onayla (hakediş yazılmaz)",
