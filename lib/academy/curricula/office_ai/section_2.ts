...
Copilot yoksa temiz Excel tablosunu Gemini veya ChatGPT sohbetine ataşla. Google Sheets bu derste yoktur; tabloyu Excel olarak indirip aynı istemi oraya yaz. Üç madde + karar cümlesi kuralı araç değişince bozulmaz. Sayı kilidi de bozulmaz: hücreden al, uydurma yüzde ekleme.

### Kenar durum / dikkat edilecek hata
Özet akıcı diye doğru değildir. Model yüzdeyi satırdan değil, tahminden üretebilir. Karar cümlesini kaynak hücreyle karşılaştır. Grafik bu derste yok; grafikleri Excel Formül dersinde (uydu 11, yakında) kuracağız. Slayt sonraki derstedir.

### Yapılmaması gereken tuzak
On sayfalık dökümü olduğu gibi yöneticiye iletmek. Özet istemek de tuzak olabilir: her şeyi özetle dersen, model dolgu üretir. Alıcı, amaç, Format, kısıt yaz: üç madde, tek karar cümlesi, uydurma sayı yok.
`,
};
