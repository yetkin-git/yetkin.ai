...
Ekrana dikkatli bak. Peki neden fark bu kadar belirgin? Çünkü sol taraftaki raporda gözden kaçan 59.450 toplamı şirketi yanlış bütçe ayırmaya veya hatalı tedarik kararına sürükleyebilirdi. Sağ tarafta ise satır toplamı ile genel toplam yeniden hesaplandı; halüsinasyon durdu. Sol taraf kör süreçtir: akıcı durur, matematik kilitli değildir. Sağ taraf dedektif süreçtir: sapma kırmızı, toplam 50.450. Aynı tabloda iki sonuç durur: biri uydurma fatura, diğeri kilitli sayı.
...
Copilot yoksa aynı çapraz kontrol istemini ataşladığın Excel tablosu üzerinde Gemini veya ChatGPT’ye yaz. TOPLA kilidi araçta değil, sende durur: satır toplamı genel toplamı vermiyorsa raporu gönderme.
