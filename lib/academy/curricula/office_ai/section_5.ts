...
Şimdi ekrandaki dikey bölünmüş karşılaştırmaya bak. Sol tarafta kontrolsüz üretilen ilk tablo duruyor. Yıldız Tekstil satırında kaynaksız biçimde uydurulmuş 21.500 liralık bir tutar var. Mart 9.100, Nisan 3.400; satır toplamı 12.500 olmalıydı. Bu gizli hata yüzünden alttaki genel toplam 59.450 gibi duruyor ama gerçek verilerle bağı yok. Yapay zekâ olmayan bir faturayı gerçek gibi listeye eklemiş. Sol panel kör süreçtir: tablo akıcı durur, matematik kilitli değildir.

Sağ taraftaki panelde dedektif istemiyle yeniden taranmış tablo yer alıyor. Sistem sol taraftaki uydurma 21.500 değerini ve buna bağlı şişen 59.450 genel toplamını tespit etti. Aradaki mantık uyuşmazlığını kırmızı ile işaretledi; kaynak evrakta böyle bir sipariş yok. Yıldız satır toplamı formülle 12.500, genel toplam 50.450. Sağ panel denetim paneli gibi çalışır: sapma görünür, toplam düşer. Böylece uydurma veri bütçeye sızmadan durdu.

## FARK ORTADA

Ekrana dikkatli bak. Fark bu kadar belirgin. Sol taraftaki raporda gözden kaçan 59.450 toplamı şirketi yanlış bütçe ayırmaya veya hatalı tedarik kararına sürükleyebilirdi. Sağ tarafta ise satır toplamı ile genel toplam yeniden hesaplandı; uydurma durdu. Sol taraf kör süreçtir: akıcı durur, matematik kilitli değildir. Sağ taraf dedektif süreçtir: sapma kırmızı, toplam 50.450. Aynı tabloda iki sonuç durur: biri uydurma fatura, diğeri kilitli sayı.
...
Bugünkü saha görevinde senden son bir ayda hazırladığın veya üzerinde çalıştığın gerçek bir veri tablosunu masaya yatırmanı istiyorum. Kişi adı, IBAN veya şirket sırrı varsa önce maskele; ham tabloyu sohbete bırakma. Yapay zekâya tablodaki satırları ve genel toplamları çapraz kontrol ettirip gizli bir uyumsuzluk aramasını iste. Copilot yoksa aynı çapraz kontrol istemini ataşladığın Excel tablosu üzerinde Gemini veya ChatGPT’ye yaz. Sistemden hatalı veya şüpheli gördüğü her satırı kırmızı ile işaretlemesini ve gerekçesini yazmasını iste. Satır toplamı genel toplamı vermiyorsa raporu gönderme. Çıkan özet akıcı olsa bile sayıyı kaynak evraktan geçirmeden masaya koyma.

Kendi veri setindeki hataları ayıklamayı bitirdiğinde bu refleks günlük çalışma tarzının parçası olur. Uydurma satır bir kez yakalanınca ertesi tabloda da aynı soruyu sorarsın. Sıradaki ders e-posta ritüelidir: etiket, taslak, insan onayı, arşiv. Gelen kutusunu sıfırlama alışkanlığını orada kuracaksın. Gmail kapısı ve Word ataşı ondan sonra gelir. Haftalık Sistem kapanış dersidir; 30 Dakika Cuma rutini ve sınav kapısı en sonda açılır. Sayı kilitlenmeden Cuma penceresini açma. Sınav, 9. ders bitince açılır. Baraj 70 puandır.

## El kitabı (kasetin sığdırmadığı)

### Lisans yoksa ne yapılır?
Copilot yoksa aynı çapraz kontrol istemini ataşladığın Excel tablosu üzerinde Gemini veya ChatGPT’ye yaz. TOPLA formülü araçta değil, sende durur: satır toplamı genel toplamı vermiyorsa raporu gönderme.
