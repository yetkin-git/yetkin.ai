...
Peki bu veriyi yapay zekâya nasıl vereceksin? Üç Kapı sırası sabittir, çünkü önce en yerinde yolu denersin. 1) Copilot lisansın varsa şeritten doğrudan okutursun — bu birinci kapıdır. 2) Yoksa dosyayı ataş simgesinden Gemini, ChatGPT veya Claude sohbetine yüklersin — ataş ikinci kapıdır. Bu dersteki örnek kişi adı taşımayan temiz bir tahsilat tablosudur. Copilot varsa şeritten doğrudan okut; yoksa dosyayı ataş ile yükle. (Kişisel verileri maskeleme kuralını 2. derste kilitleyeceğiz.) 3) Son çare: isim ve telefonu maskeleyip kısa bir özeti yapıştırırsın. Ham tabloyu ekran görüntüsüyle taşımak öğretilen yol değildir; çünkü ekran görüntüsü hücreleri bozar ve A1 eşiğini kaybettirir.
...
Excel Copilot şeridi yoksa bu dersteki anonimize edilmiş / temiz örnek dosyayı Gemini, ChatGPT veya Claude sohbetine ataşla. Gerçek müşteri satırını henüz yükleme; kişisel verileri maskeleme kuralını 2. derste kilitleyeceğiz. Neden? Çünkü lisanslı şerit zorunlu değildir; üç araç da A1 eşiğini ister. Şirket API’si varsa evdeki kuralı oraya taşı.
