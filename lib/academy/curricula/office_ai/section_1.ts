...
export const section1: Section = {
  ...
  targetDurationMinutes: 11.0,
  estimatedWordCount: 1545,
  pedagogicalObjective:
    "Düzensiz Excel tablosunu A1 hücresinden başlayarak düzenli tabloya çevirmeyi göstermek. Neden A1? Çünkü model tablonun nereden başladığını oradan okur. Yükleme kimliği gizlenmiş örnek tablo üzerinden yapılır; maskeleme kuralı 2. derste kilitlenir. ChatGPT, Claude, Gemini ve şirket paneli (kurumsal model) farkını eğilim diliyle oturtmak.",
  contentMarkdown: `
...
Excel Copilot düğmesi yoksa bu dersteki kimliği gizlenmiş örnek tabloyu Gemini, ChatGPT veya Claude sohbetine ataşla. Gerçek müşteri satırını henüz yükleme; kişisel verileri maskeleme kuralını 2. derste kilitleyeceğiz. Neden? Çünkü Copilot düğmesi zorunlu değildir; üç araç da A1 kuralını ister. Şirket paneli varsa evdeki kuralı oraya taşı.
