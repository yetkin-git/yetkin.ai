...
export const section1: Section = {
  ...
  pedagogicalObjective:
    "Düzensiz Excel tablosunu A1 hücresinden başlayarak düzenli tabloya çevirmeyi göstermek. Neden A1? Çünkü model tablonun nereden başladığını oradan okur. ChatGPT, Claude, Gemini ve özel AI API farkını insani dille oturtmak.",
  contentMarkdown: `
