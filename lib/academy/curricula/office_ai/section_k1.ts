...
export const sectionK1: Section = {
  ...
  targetDurationMinutes: 11.7,
  estimatedWordCount: 1505,
  pedagogicalObjective:
    "Müşteri listesini, IBAN, T.C. Kimlik No, maaş ve şirket sırrını açık yapay zekâ ekranına yüklememeyi göstermek. Maskeleme (gerçek satırda takma değer) ile örnek satır (yalnız tablo şekli) iki ayrı tekniktir. Önce şirket politikası, sonra veri sınıfı, sonra aktarım yolu.",
  contentMarkdown: `
...
Sıra sende. Masandaki bir gerçek listeyi aç. Ad, telefon, IBAN, T.C. Kimlik No varsa maskele. Üç satırlık soru yaz. Ham dosyayı sohbet yapay zekâsına bırakma. Üç sahte satır tablo şeklini gösterir; bin gerçek satırın özetini maskeli satır verir. Bunu masada fark edeceksin. Sıradaki kapı rapordur: temiz ve maskeli tablodan üç maddelik yönetim özeti.
