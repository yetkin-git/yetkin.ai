...
export const sectionK1: Section = {
  ...
  targetDurationMinutes: 11.1,
  estimatedWordCount: 1411,
...
Peki iki taraf arasındaki fark nerede durur? Fark, hangi aracı açtığında değil, o araca neyin girdiğindedir. Copilot, Gemini, ChatGPT aynı kuralı taşır. Hangi sohbeti kullanırsan kullan, içeri giren ham ad hâlâ ham addır. Listen değişir; modelin adı değişmez. Gördüğün gibi doğru maske, raporu yavaşlatmaz. Yanlış yapıştırma şudur: sohbet kutusunu kendi arşivin sanırsın. Sil düğmesi, yüklemiş olmanı geri almaz. Bu yüzden doğru adım, içeri giren satırı maskelemektir.
...
Lisans ve veri işleme sözleşmesi (DPA) tek başına yetmez; bilgilendirme ve izin (aydınlatma + açık rıza) ile devletin veri sicili (VERBİS) zemini kurulmadan ham kimlik hiçbir panele girmez. Neden? Çünkü lisans, sohbet kutusuna giren satırın sınıfını tek başına değiştirmez. Lisans yoksa da, varsa da kural aynıdır: ad + telefon + IBAN ham haliyle gitmez. Yapay zekâya tablonun mantığını kavratmak için maskeli üç satır yeter; bin kişilik gerçek liste gerekmez. Sohbet yurt dışındaki sunucuda durur; KVKK izinsiz yurt dışına veri çıkarmayı yasaklar. Sohbeti silmek, o sunucudan silmez; yüklemiş olmanı geri almaz.
