<!--
  ...
  1. Kapı: yerleşik yapay zekâ (Gmail Gemini / Outlook Copilot). Tıklama tekerlemesi yok.
  İstem kutusu SSOT: lib/academy/lesson-beat-visual.ts (ACADEMY_OFFICE_AI_G1_COPILOT_PROMPT)
