...
export const AI_TEMEL_QUESTIONS: AcademyExamQuestion[] = [
  ...
  mcq("q_ai_14", "Satın alma belge midir?", ["Evet", "Hayır; belge sınav barajından sonra", "Evet hash", "Yalnız satın alma"], 1),
  ...
  mcq("q_ai_18", "Sertifika ne zaman basılır?", ["Satın alınca", "Sınav barajı üstünde", "İlk prompt’ta", "PDF’te"], 1),
...
export const UX_TEMEL_QUESTIONS: AcademyExamQuestion[] = [
  ...
  mcq("q_ux_14", "Satın alma belge midir?", ["Evet", "Hayır; belge sınav barajından sonra", "Evet hash", "Yalnız satın alma"], 1),
  ...
  mcq("q_ux_17", "Sertifika ne zaman basılır?", ["Satın alınca", "Sınav barajı üstünde", "İlk Figma’da", "Beğenide"], 1),
