    ...
    cues: [
      ...
      },
      {
        ...
        copilot: {
          hideReply: true,
          prompt:
            "Bu düz metni slayt başına tek fikir ve görsel yönlendirme ile taslağa çevir. Copilot varsa şeride yaz; yoksa pptx ataşla. Biten sunumu henüz açma.",
          replyLines: [],
        },
        nodes: [
      ...
      },
      {
        ...
        section: "SIRA SENDE",
        headline: "SIRA SENDE",
        subhead: "Kendi metnini tek tıkla slayt yapısına çevir. Sonra gelen kutusu.",
        bullets: ["Kendi metnini seç", "Slayt yapısı", "L4 e-posta köprüsü"],
    ...
    cues: [
      {
        ...
        section: "GİRİŞ KÖPRÜSÜ",
        headline: "GİRİŞ KÖPRÜSÜ",
        subhead: "Sunum Fabrikası cebinde. Şimdi yüzlerce okunmamış mail stresi başlıyor.",
        bullets: ["Hiyerarşi cebinde", "Inbox kaosu", "Okunmamış sel"],
      ...
      },
      {
        ...
        section: "SIRA SENDE",
        headline: "SIRA SENDE",
        subhead: "Kendi gelen kutunu 3 kuralla sıfırla. Sonra istisnalar.",
        bullets: ["Kendi kutunu seç", "Üç kural", "L5 hata avı köprüsü"],
        tools: ["Outlook", "Copilot"],
        layout: "outlook",
        highlightCell: "A1",
        fileName: "Gelen_Kutusu.ost",
    ...
    cues: [
      {
        ...
        section: "GİRİŞ KÖPRÜSÜ",
        headline: "GİRİŞ KÖPRÜSÜ",
        subhead: "E-posta sıfırlama cebinde. Şimdi rapordaki halüsinasyon stresi başlıyor.",
        bullets: ["Inbox sıfırlandı", "Aşırı güven", "Hata gömülü"],
        tools: ["Excel", "Copilot"],
        layout: "excel",
        highlightCell: "A1",
      ...
      },
      {
        ...
        section: "SIRA SENDE",
        headline: "SIRA SENDE",
        subhead: "Kendi tablonda uydurma rakamı yakala. Sonra haftalık rutin.",
        bullets: ["Kendi verini seç", "Çapraz sorgu", "L6 rutin köprüsü"],
        tools: ["Excel", "Copilot"],
        layout: "excel",
        highlightCell: "D4",
        fileName: ACADEMY_ERROR_HUNT_FILE_NAME,
    ...
    cues: [
      {
        ...
        section: "GİRİŞ KÖPRÜSÜ",
        headline: "GİRİŞ KÖPRÜSÜ",
        subhead: "Hata avı cebinde. Şimdi o avı Cuma takvimine bağla.",
        bullets: ["Halüsinasyon avı", "Kriz tekrarı", "Cuma penceresi"],
        tools: ["Excel", "Copilot"],
        layout: "excel",
        highlightCell: "A1",
      ...
      },
      {
        ...
        section: "ÜÇ BLOK",
        headline: "ÜÇ BLOK",
        subhead: "Beat 3 açılır: sol dağınık hafta, sağ Cuma otuz sistemli rutin.",
        bullets: ["Excel", "Slayt", "E-posta"],
        tools: ["Excel", "Copilot"],
        layout: "excel",
        highlightCell: "A1",
        fileName: ACADEMY_WEEKLY_ROUTINE_FILE_NAME,
      ...
      },
      {
        ...
        bullets: ["Sol kriz tekrarı", "Sağ Cuma otuz", "İnsan gözü"],
        tools: ["Excel", "Copilot"],
        layout: "excel",
        highlightCell: "C1",
        fileName: ACADEMY_WEEKLY_ROUTINE_FILE_NAME,
      ...
      },
      {
        ...
        section: "SIRA SENDE",
        headline: "SIRA SENDE",
        subhead: "Cuma 30’u takvime koy. Sonra Gmail yerinde, Word ataş.",
        bullets: ["Takvime koy", "Tabloyu ataşla", "L7 Gmail köprüsü"],
        tools: ["Excel", "Copilot"],
        layout: "excel",
        highlightCell: "A1",
        fileName: ACADEMY_WEEKLY_ROUTINE_FILE_NAME,
    ...
    cues: [
      {
        ...
        section: "GİRİŞ KÖPRÜSÜ",
        headline: "GİRİŞ KÖPRÜSÜ",
        subhead: "Gelen kutusunu kopyalayıp taşımak taşıma sudur. Asıl kapı Gmail içinde Gemini.",
        bullets: ["Taşıma su yasak", "Gmail kapısı", "Gemini yerleşik"],
        tools: ["Gmail", "Gemini"],
        layout: "gmail",
        highlightCell: "A1",
      ...
      },
      {
        ...
        section: "HOŞ GELDİN",
        headline: "HOŞ GELDİN",
        subhead: "Gözde masada. Gelen kutusu Gmail’de kalır; ChatGPT’ye taşınmaz.",
      ...
      },
      {
        ...
        section: "TAŞIMA SU",
        headline: "TAŞIMA SU",
        subhead: "Mailleri kopyalayıp dış sohbete yapıştırmak kutuyu koparır. Öğretilmez.",
        bullets: ["Ctrl+C yasak", "Ekran görüntüsü yok", "Kutu kopuk"],
        tools: ["Gmail", "Gemini"],
        layout: "gmail",
        highlightCell: "A1",
        fileName: "Gelen_Kutusu.gmail",
      ...
      },
      {
        ...
        section: "GEMİNİ AÇ",
        headline: "GEMİNİ AÇ",
        subhead: "Gmail yan panelinde Gemini’yi aç. İstem oraya yazılır. Özet henüz yok.",
  ...
  "01_office_ai-w1": {
    ...
    cues: [
      ...
      },
      {
        ...
        section: "SIRA SENDE",
        headline: "SIRA SENDE",
        subhead: "Kendi sözleşmeni ataşla. Spesifik bir paragrafı sorabilirsin.",
        bullets: ["Kendi dosyan", "Üç kural", "Ana akış köprüsü"],
        tools: ["Word", "Gemini"],
        layout: "word",
        highlightCell: "A1",
        fileName: "Sozlesme_Kaya_Gida.docx",
    ...
    cues: [
      {
        ...
        section: "GİRİŞ KÖPRÜSÜ",
        headline: "GİRİŞ KÖPRÜSÜ",
        subhead: "Ataş alışkanlığı yanlış dosyada insanı ifşa eder. Neyin yüklenmeyeceğini öğren.",
        bullets: ["Ham liste yasak", "Maske refleksi", "3. Kapı kısa"],
        tools: ["Excel", "Copilot"],
        layout: "excel",
        highlightCell: "A1",
      ...
      },
      {
        ...
        bullets: ["Selamlar, ben Gözde", "KVKK omurgası", "Sınav tüm dersler sonra"],
        tools: ["Excel", "Copilot"],
        layout: "excel",
        highlightCell: "A1",
        fileName: ACADEMY_KVKK_FILE_NAME,
      ...
      },
      {
        ...
        subhead: "Ad, telefon, IBAN, maaş, kimlik. Maskeli tablo kapalı.",
      ...
      },
      {
        ...
        section: "MASKELE",
        headline: "MASKELE",
        subhead: "Üç satır maskeli soru yazılır. Maskeli tablo yok; zoom.",
        bullets: ["Baş harf", "Kırpılmış IBAN", "Kısa soru"],
        tools: ["Excel", "Copilot"],
        layout: "excel",
        highlightCell: "A1",
        zoomA1: true,
      ...
      },
      {
        ...
        subhead: "1. Kapı panel, 2. Kapı ataş, 3. Kapı maskeli kısa. Ham kutu atlanmıştır.",
        bullets: ["Yerleşik panel", "Ataş", "Maskeli kısa"],
        tools: ["Excel", "Copilot"],
        layout: "excel",
        highlightCell: "A1",
        fileName: ACADEMY_KVKK_FILE_NAME,
      ...
      },
      {
        ...
        section: "FARK ORTADA",
        headline: "FARK ORTADA",
        subhead: "Sol ham yapıştırma. Sağ maskeli kısa özet.",
      ...
      },
      {
        ...
        section: "SIRA SENDE",
        headline: "SIRA SENDE",
        subhead: "Kendi listeni maskele. Sınav köprüsü tüm dersler bitince açılır.",
        bullets: ["Kendi listen", "Üç kural", "Sınav kapısı"],
        tools: ["Excel", "Copilot"],
        layout: "excel",
        highlightCell: "A1",
        fileName: ACADEMY_KVKK_FILE_NAME,
