  ...
  "01_office_ai-6": {
    ...
    cues: [
      ...
      },
      {
        ...
        section: "SIRA SENDE",
        headline: "SIRA SENDE",
        subhead: "Cuma 30’u takvime koy. Bu kapanış dersidir; sonra sınav kapısı.",
        bullets: ["Takvime koy", "Tabloyu ataşla", "Sınav köprüsü"],
        tools: ["Excel", "Copilot"],
        layout: "excel",
        highlightCell: "A1",
        fileName: ACADEMY_WEEKLY_ROUTINE_FILE_NAME,
    ...
    cues: [
      {
        ...
        section: "GİRİŞ KÖPRÜSÜ",
        headline: "GİRİŞ KÖPRÜSÜ",
        subhead: "Gelen kutusunu kopyalayıp taşımak atlanmış kapıdır. Asıl kapı Gmail içinde Gemini.",
