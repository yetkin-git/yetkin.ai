...
export const OFFICE_AI_EXAM_QUESTIONS: AcademyExamQuestion[] = [
  ...
  mcq(
    ...
    [
      ...
      "Dilekçeyi yüklemeden sayfa sayfa kopyalamak",
    ],
    1,
  ),
  mcq(
  ...
  mcq(
    ...
    [
      ...
      "Sözleşmeyi Word belgesi olarak yükleyip dosyanın bütününü inceletmek",
  ...
  mcq(
    ...
    [
      ...
      "Kanun maddesini modelden olduğu gibi basmak",
      "Dosyayı yüklemeden sayfa sayfa kopyalamak",
    ],
    1,
  ),
  mcq(
